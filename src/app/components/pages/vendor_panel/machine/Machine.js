                            ...
                            <div className="row">
                                <div className="card-content">
                                    ...
                                    <div class="d-grid gap-2 mt-4">
                                        <button class="btn btn-danger rounded-full p-1" type="button">Refill</button>
                                        <div className="row mt-2">
                                            <div className="d-grid col-lg-6">
                                                <button class="main-btn secondary-btn rounded-full p-1" type="button">All Products</button>
                                            </div>
                                            <div className="d-grid col-lg-6">
                                                <button class="main-btn dark-btn rounded-full p-1" type="button">Transactions</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
